...
PACKAGENAME = metadata.get('package_name', 'astrocalib')
DESCRIPTION = metadata.get('description', 'AstroCalib')
AUTHOR = metadata.get('author', 'fockez')
AUTHOR_EMAIL = metadata.get('author_email', '')
LICENSE = metadata.get('license', 'unknown')
URL = metadata.get('url', 'http://www.pmo.ac.cn')
